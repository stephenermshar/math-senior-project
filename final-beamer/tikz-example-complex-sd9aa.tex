...
% Text Node
\draw (27.5,66.5) node    {$v_{1}$};
% Text Node
\draw (54,18.5) node    {$v_{2}$};
% Text Node
\draw (80,58.5) node    {$v_{3}$};
% Text Node
\draw (117,16) node    {$v_{4}$};
% Text Node
\draw (131.5,74) node    {$v_{5}$};
% Text Node
\draw (172,62) node    {$v_{6}$};
% Text Node
\draw (176,13.5) node    {$v_{7}$};
